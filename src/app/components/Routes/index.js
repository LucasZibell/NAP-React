    ...
    <ConnectedRouter history={history}>
      <Suspense>
        <Switch>
          ...
          <AuthenticatedRoute isPrivateRoute exact path={Routes.ALGORITHM_GUIDE} component={RoboticsGuide} />
          <AuthenticatedRoute isPrivateRoute exact path={Routes.ROBOTICS_GUIDE} component={AlgorithmGuide} />
